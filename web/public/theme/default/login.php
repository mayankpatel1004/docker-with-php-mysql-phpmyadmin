            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                ...
                <form class="pt-3">
                  ...
                  <div class="mt-3">
                    <a class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="<?php echo $url;?>">SIGN IN</a>
                  </div>
                  <div class="my-2 d-flex text-right">
                    <a href="forgotpassword.php" class="auth-link text-black text-right">Forgot password?</a>
                  </div>
