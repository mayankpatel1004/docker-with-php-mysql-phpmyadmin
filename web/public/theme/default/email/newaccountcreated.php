                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="5" style="color:#25378b">
                        ...
                        <tr>
                            <td>
                                ...
                                <p>your account has been created on #sitename#.</p>
                                <p>please set a new password by following the link below.</p>
                                <p><strong><a href="#activationlink#">#activationlink#</a></strong></p>
                                <p>If you don't want to set your password, just ignore this message.</p>
                        ...
                        <tr>
                            <td align="center" bgcolor="#F7F7F7"><h3>#companyname#</h3>
