<?php
require_once $theme_path.'model/Allvisitors.php';
class Allvisitorscontroller {

    public $model;
    public function __construct(){
        $this->model = new Allvisitors();
    }
    ...
    public function index() {
        ...
        //echo "<pre>";print_r($_SESSION[$back_session_name]);
        //echo $_SESSION[$back_session_name][$item_alias]['page_no'];
        ...
        $columns_header = "Rec-ID,Title,IP,Country,Region,City,Platform,Browser";
        $sort_array = array(
            'log_id__asc' => 'Oldest First',
            'log_id__desc' => 'Newest First',
            'title__asc' => 'Title ASC',
            'title__desc' =>'Title DESC'
        );
        require $theme_path.'views/allvisitors.php';
    }
