                            ...
                            foreach($arrFields as $fields) {
                                ...
                                if($fields['type'] == 'hidden') :
                                    ...
                                    if(isset($fields['value']) && $fields['value'] != ''){
                                        $text_value = $fields['value'];
                                    }
                                    else if(isset($arrOnedata[$fields['name']]) && $arrOnedata[$fields['name']] != '')
                                    {
                                        $text_value = $arrOnedata[$fields['name']];
                                    }
                                    ?>
                                    <input type="hidden" class="form-control" name="<?php echo $fields['name'];?>" id="<?php echo $fields['name'];?>" autocomplete="off" value="<?php echo $text_value;?>" />
                                    <?php
                                endif;
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        ?>
                                        <input type="<?php echo $fields['type'];?>" class="form-control" name="<?php echo $fields['name'];?>" id="<?php echo $fields['name'];?>" autocomplete="off" value="<?php echo $text_value;?>" />
                                        <?php
                                        if($fields['type'] == 'file') {
                                ...
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        ...
                                        if($existing_value != 'NOINDEX,NOFOLLOW' || $existing_value != 'INDEX,FOLLOW')
                                        {
