...
<div class="content-wrapper">
    <div class="col-12 grid-margin">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title text-primary"><?php echo ucfirst(str_replace('_',' ',$item_alias));?> form</h4>
                ...
                <form class="form-sample" action="<?php echo $save_url ; ?>" id="ajax-upload" method="post" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <input type="hidden" class="form-control" name="item_type" id="item_type" autocomplete="off" value="<?php echo $item_alias;?>" />
                        <?php
