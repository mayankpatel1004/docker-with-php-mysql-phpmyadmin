                    ...
                    <div class="row">
                        ...
                        if(isset($arrFields) && !empty($arrFields)) {
                            foreach($arrFields as $fields) {
                                ...
                                if($fields['type'] == 'text' || $fields['type'] == 'date'):
                                ?>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <label class="col-sm-12 col-form-label"><?php echo $fields['title'];?></label>
                                        <div class="col-sm-12">
                                            <select class="js-example-basic-single w-100" name="<?php echo $fields['name'];?>" id="<?php echo $fields['name'];?>" <?php if(isset($fields['onchange']) && $fields['onchange'] != '') { echo "onchange=".$fields['onchange']?> <?php }?>>
                                                <?php if(isset($fields['options']) && !empty($fields['options'])):?>
                                                    ...
                                                    <?php foreach($fields['options'] as $key => $value):?>
                                                        ...
                                                        if(isset($_SESSION[$back_session_name]['user_id']) && $_SESSION[$back_session_name]['user_id'] > 0) {
                                                            $arrOnedata[$fields['name']] = $_SESSION[$back_session_name]['user_id'];
                                                        }
                                                        //$arrOnedata[$fields['name']]
                                                        ?>
...
<?php require $theme_path.'include/scripts.php';?>
    ...
    function getTasks(project_id) {
            ...
            $.ajax({
                url: '<?php echo $url.'alltimecard/getTasks/?project_id=';?>'+project_id,
                dataType: 'json',
                method : "post",
                contentType: false,
                cache: false,
