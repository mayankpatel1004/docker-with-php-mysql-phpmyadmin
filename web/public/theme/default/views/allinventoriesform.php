                ...
                <form class="form-sample" action="<?php echo $save_url ; ?>" id="ajax-upload" method="post" enctype="multipart/form-data">
                        ...
                        if(isset($arrFields) && !empty($arrFields)) {
                            foreach($arrFields as $fields) {
                                ...
                                if($fields['type'] == 'hidden') :
                                    ?>
                                    <input type="hidden" class="form-control" name="<?php echo $fields['name'];?>" id="<?php echo $fields['name'];?>" autocomplete="off" value="<?php if(isset($arrOnedata[$fields['name']]) && $arrOnedata[$fields['name']] != ''){echo $arrOnedata[$fields['name']];} else { echo isset($fields['value']) && $fields['value'] != "" ? $fields['value'] : '';}?>" />
                                    <?php
                                endif;
                                if($fields['type'] == 'text'):
                                    $readonly = "";
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="<?php echo $fields['type'];?>" class="form-control" name="<?php echo $fields['name'];?>" id="<?php echo $fields['name'];?>" autocomplete="off" value="<?php if(isset($arrOnedata[$fields['name']]) && $arrOnedata[$fields['name']] != ''){echo $arrOnedata[$fields['name']];} else {echo isset($fields['value']) && $fields['value'] != "" ? $fields['value'] : '';}?>" <?php echo $readonly;?> />
                    ...
                    <div class="row">
                        <div class="col-md-12 text-danger">
                            Note : Size required to enter only when item is partial used. Example Rope which arrived at 10 Quantity with size 2000M. In this case size is requred to enter.
                        </div>
