...
<div class="content-wrapper">
    <div class="col-12 grid-margin">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title text-primary"><?php echo $item_alias;?> Inventory Stock</h4>
                ...
                <form class="form-sample" action="<?php echo $save_url ; ?>" id="ajax-upload" method="post" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <?php
                        if(isset($arrFieldsStock) && !empty($arrFieldsStock)) {
                            foreach($arrFieldsStock as $fields) {
                                $mandatory = "";
                                $required = "";
            ...
            $.ajax({
                ...
                success: function(result){
                    if(result.error == '0'){
                        ...
                        //location.href = '< ?php echo $url."inventorystock"; ?>';
                    }else{
