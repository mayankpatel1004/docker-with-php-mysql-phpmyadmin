...
<head>
  ...
  <title class="text-primary">Reset Password</title>
              ...
              <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                ...
                <form class="pt-3">
                  <div class="form-group">
                    ...
                    <input type="hidden" name="customer_id" id="id" value="<?php echo $customer_id;?>" />
                  ...
                  <div class="text-center mt-4 font-weight-light"> Not You ? <a href="<?php echo $url."forgotpassword";?>" class="text-primary">Click here.</a>
                  <div class="text-center mt-4 font-weight-light"> Know your password ? <a href="<?php echo $url."login";?>" class="text-primary">Click here.</a>
                  <br /><br />
                  </div>
                </form>
              </div>
          ...
          if(document.getElementById("password").value == ''){
            ...
            $(".success_error").html('');
              ...
              $.ajax({
                ...
                cache: false,
                processData:false, 
                url: site_url+'resetcustomerpassword',
